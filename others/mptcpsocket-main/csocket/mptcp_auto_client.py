...
pcapfile1 = "%s/CLIENT_UL_%s_%s.pcap"%(pcap_path, PORT, n)
filename = "c_port_%s_running.tmp"%(PORT)
...
socket_proc =  subprocess.Popen(["./client.o %s %g %d&"%(PORT, bandwidth, length_packet)], shell=True, preexec_fn=os.setsid)
