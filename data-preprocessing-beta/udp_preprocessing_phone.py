...
exps = {  # experiment_name: (number_of_experiment_rounds, list_of_experiment_round)
    ...
    # "Bandlock_B1_B3_B7_B8_Dupl_Phone": (4, ["#{:02d}".format(i+1) for i in range(4)]),
    # "Bandlock_All_B3_B7_B8_Dupl_Phone": (4, ["#{:02d}".format(i+1) for i in range(4)]),
...
_schemes = [
    ...
    # ["B1_0", "B1_1", "B3_0", "B3_1", "B7_0", "B7_1", "B8_0", "B8_1",],
